...
public interface UserDao {
    ...
    List<DBObject> withinMultiPolygon(String collection, String locationField, List<double[]> polygon1, List<double[]> polygon2, DBObject fields, DBObject query, int limit);
}
